...
- **Documentation**: `docs/cpp-api-design.md` for C++ wrapper API
...
- **Documentation**: Renamed `api-design.md` to `c-api-design.md`, updated for accuracy

### Removed

- `docs/initial-analysis.md` (superseded by documentation)
